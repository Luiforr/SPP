...
<h2 class=" font-bold text-4xl text-center mb-8">Login Siswa</h2>
<div>
    <label class="font-semibold ">NIS</label>
    <input type="text" name="nis" required placeholder="nis" class="w-full h-12 px-4 py-2 rounded-xl focus:outline-none focus:ring-2 outline-1 focus:ring-[#2D5074] bg-[#D1CECA]  placeholder-[#123458]">
    </div>
