...
<body class="">
    ...
    <div class="container mx-auto  my-5 p-5 bg-white rounded shadow-md text-center">
        <div class="flex justify-between mb-4 text-center">
            <a href="kelas/index.php" class="text-3xl  mb-5 text-center cursor-pointer">Daftar Kelas</a>
        </div>
                    ...
                    <?php foreach ($kelasData as $kelas): ?>
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2">
                                ...
                                <a href="dashboard.php?deleteKelas=<?= $kelas['id_kelas']; ?>"
                                    onclick="return confirm('Yakin ingin menghapus data ini?')"
                                    class="text-[#FF0000] font-medium hover:underline">Delete</a>
                            </td>
                        </tr>
    ...
    <div class="container mx-auto  my-5 p-5 bg-white rounded shadow-md text-center">
        <div class="flex justify-between mb-4 text-center">
            <a href="spp/index.php" class="text-3xl  mb-5 text-center cursor-pointer">Daftar SPP</a>
        </div>
                    ...
                    <?php foreach ($sppData as $spp): ?>
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2">
                                ...
                                <a href="dashboard.php?deleteSpp=<?= $spp['id_spp']; ?>"
                                    onclick="return confirm('Yakin ingin menghapus data ini?')"
                                    class="text-[#FF0000] font-medium hover:underline">Delete</a>
                            </td>
                        </tr>
